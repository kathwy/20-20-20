...
def sleep():
    ...
    for image in widget_list:
        image.pack_forget()
    os.system("pmset displaysleepnow -t 20; sleep 20; caffeinate -u -t 1") # change the numbers for dim time in seconds

def show_image(i):
    # you can change the gifs to go along with your messages
    image_dict = {1:"", 2:"", 3:"3.gif", 4:"4.gif", 5:"5.gif", 6:"", 7:"", 8:"8.gif", 9:"9.gif", 10:"", 11:"", 12:"12.gif"}
...
def main():
    ...
    If they don't comply, send reminders/gifs/fun facts every 10 minutes until they do
    '''
    ...
    messages =  {1: "The prevalence of nearsightedness among Americans has increased by 66% over the past 30 years. Give your eyes a rest.",
    ...
    while True:
        ...
        if complied:
            notify(messages['title'],
                   messages['subtitle'],
                   messages['message_20'])
        if sass_factor < number_messages:
            ...
            if sass_factor != 0:
                if sass_factor <= number_messages:
                    ...
                    notify(messages['title'],
                           messages['subtitle'],
                           messages['message_10'])
                    tkinter.messagebox.showinfo("FUN FACT", str(messages[number_messages]))
