...
def main():
    ...
    time_between_reminders = 5 # 600 sec = 10 min in between reminders
    ...
    messages = {1: "Spending hours on a computer or hand-held device keeps the eyes converged and strains the eye muscles to cause headaches.",
    ...
    while True:
        ...
        if tkinter.messagebox.askyesno("HEALTH", prompt_message):
            complied = True
            sleep()
